        ...
        routing.on 'view' do
          routing.on String do |room_id| #udah ada tapi harus ubah api
            ...
            routing.on 'delete' do
              ...
              routing.delete do
                output = Cryal::RoomService.new(App.config).delete(routing, @current_account, room_id)
            ...
            routing.on 'leave' do
              ...
              routing.delete do
                output = Cryal::RoomService.new(App.config).leave(routing, @current_account, room_id)
